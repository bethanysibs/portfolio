...
<div class="h-full homeBg flex flex-col items-center space-y-8 pb-8">
    <div class="flex mt-12 justify-center w-full space-x-20">
        ...
        <div class="w-1/2 space-y-4 mt-10">
            <h2 class="content uppercase">
                Frontend Developer currently based in the Philippines
            </h2>
            <h4 class="content w-2/3">
    ...
    <div class="flex justify-center w-full px-16 space-x-8 items-center py-8">
        ...
        <div class="w-1/2 px-8">
            <div class="flex flex-col space-y-10">
                ...
                <div class="box bg-gray-500 p-4 flex items-center space-x-4">
                    <img class="icons" src="assets/img/uiDesign.png" />
                    <h5 class="content">Other Projects</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex justify-center w-full px-16 items-center">
        <div class="grid sm:grid-cols-12 gap-8" id="portfolio">
            ...
            <div class="col-span-3 box bg-gray-500 w-48 h-32 p-4 border">01</div>
            <div class="col-span-3 box bg-gray-500 w-48 h-32 p-4 border">01</div>
            <div class="col-span-3 box bg-gray-500 w-48 h-32 p-4 border">01</div>
            <div class="col-span-3 box bg-gray-500 w-48 h-32 p-4 border">01</div>
            <div class="col-span-3 box bg-gray-500 w-48 h-32 p-4 border">01</div>
